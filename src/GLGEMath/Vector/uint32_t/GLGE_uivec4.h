...
typedef struct s_uivec4 {
     ...
     * 
     */
    inline s_uivec4() : x(0), y(0), z(0), w(0) {}
     ...
     */
    inline s_uivec4(uint32_t _x, uint32_t _y, uint32_t _z, uint32_t _w) : x(_x), y(_y), z(_z), w(_w) {}
     ...
     */
    inline s_uivec4(uint32_t xyzw) : x(xyzw), y(xyzw), z(xyzw), w(xyzw) {}
     ...
     */
    inline s_uivec4(const uivec2& xy, const uivec2& zw) : x(xy.x), y(xy.y), z(zw.x), w(zw.y) {}
     ...
     * @param _w the value for the w axis / alpha channel
     */
    inline s_uivec4(const uivec3& xyz, uint32_t _w) : x(xyz.x), y(xyz.y), z(xyz.z), w(_w) {}
     ...
     */
    inline s_uivec4(uint32_t _x, const uivec3& yzw) : x(_x), y(yzw.x), z(yzw.y), w(yzw.z) {}
     ...
     */
    inline s_uivec4(const __m128i& _simd) : simd(_simd) {}
     ...
     */
    inline s_uivec4 operator-(void)  const noexcept
 ...
 */
inline const uint32_t dot(const uivec4& v, const uivec4& u) noexcept {return v.x * u.x + v.y * u.y + v.z * u.z + v.w * u.w;}
